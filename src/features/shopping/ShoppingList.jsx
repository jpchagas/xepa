...
function ShoppingList({ items, getProductName, getProductUnit, getDisplayUnit, getEffectivePrice, updateAmount, removeItem, getPriceColor, formatCurrency, totalPrice, selectedList }) {
  return (
